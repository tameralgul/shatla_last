...
<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    ...
    <div class="d-flex align-items-center flex-wrap mr-2">
        ...
        <span class="text-muted font-weight-bold mr-4">الوسوم</span>
        <!--end::Actions-->
    </div>
</div>
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    <h3 class="card-label">الوسوم
                        <span class="d-block text-muted pt-2 font-size-sm">عرض جميع &amp; الوسوم</span>
                    </h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap table-bordered" id="tags_datatable">
                                    <thead>
                                        <tr>
                                            <th width="3%">#</th>
                                            <th width="13%">الوسم</th>
...
<!-- Modal -->
<div class="modal fade" id="edit_tag_Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body p-0">
                <form class="form" id="edit_tag_form">
                    <div class="card-body">
                        <div class="form-group">
                            <label>الوسم :</label>
                            <div class="input-icon input-icon-right">
...
<script>
    ...
    oTable = $('#tags_datatable').DataTable({
    "paging": true,
    "lengthChange": true,
    "searching": true,
    "ordering": true,
...
<script>
    ...
    $('#btn_show_modal').on('click',function(event) {
       ...
       $("#modelHeading").html("أضافة وسم جديد");
        $("#tag_form").trigger('reset');//to clear the form
        $("#tagModal").modal('show');   
    });
    ...
    let formData = new FormData($('#tag_form')[0]);
    $.ajax({
    type: 'POST',
